...
**Format:**
- `YYYYMMDD` = Date (e.g., `20260308`)
- `HHMM` = Time in UTC (e.g., `1441` for 14:41)
...
**Why:** Handoff files contain internal session context and should NEVER be in the public repository.
...
3. **What's Next** (priority tasks, dependencies, blockers)
...
2. **Task Breakdown** (status, effort, dependencies, success criteria)
